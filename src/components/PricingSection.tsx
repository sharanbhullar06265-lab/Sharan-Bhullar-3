...
export const PricingSection: React.FC<PricingSectionProps> = ({ onSelectTier }) => {
  ...
  return (
    <section id="pricing" className="py-16 sm:py-24 px-6 sm:px-12 md:px-16 border-t border-[#E7E6E2]">
      ...
      <div className="text-center max-w-xl mx-auto mb-12 sm:mb-16">
        ...
        <h2 className="text-3xl sm:text-5xl font-extrabold text-[#141414] tracking-tight">
          Simple pricing, no surprises
        </h2>

        <p className="text-base text-[#6E6E6E] font-medium mt-4">
          Pick the package that fits where your business is right now.
        </p>

        {/* Currency Switcher */}
        <div className="inline-flex items-center bg-[#F3F3F1] border border-[#E7E6E2] rounded-full p-1 mt-6">
          <button
            onClick={() => setCurrency('INR')}
            className={`px-4 py-1 rounded-full text-xs font-bold transition-all cursor-pointer ${
              currency === 'INR' ? 'bg-[#141414] text-white shadow-xs' : 'text-[#6E6E6E] hover:text-[#141414]'
            }`}
          >
            INR (₹)
          </button>
          <button
            ...
            className={`px-4 py-1 rounded-full text-xs font-bold transition-all cursor-pointer ${
              currency === 'USD' ? 'bg-[#141414] text-white shadow-xs' : 'text-[#6E6E6E] hover:text-[#141414]'
            }`}
          >
            USD ($)
          </button>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch max-w-6xl mx-auto">
        ...
        {/* Tier 1: Starter */}
        <div className="bg-[#F3F3F1] border border-[#E7E6E2] rounded-3xl p-7 sm:p-8 flex flex-col justify-between hover:border-[#141414] transition-all">
          <div>
            <div className="text-[15px] font-bold text-[#141414] mb-3">
              Starter
            </div>

            <div className="flex items-baseline gap-1 font-extrabold text-[#141414] mb-2">
              <span className="text-2xl font-bold">{currency === 'INR' ? '₹' : '$'}</span>
              <span className="text-5xl tracking-tight">{currency === 'INR' ? '15k' : '499'}</span>
              <span className="text-sm font-semibold text-[#6E6E6E]">/ project</span>
            </div>

            <p className="text-[13.5px] text-[#6E6E6E] font-medium mb-6">
              A focused one-page site to get you online fast and looking credible.
            </p>

            <ul className="space-y-3 pt-6 border-t border-[#E7E6E2] text-[13.5px] font-medium text-[#141414]">
              <li className="flex items-center gap-2.5">
                <Check className="w-4 h-4 text-[#141414] flex-shrink-0" />
          ...
          <button
            ...
            className="w-full mt-8 bg-white border border-[#E7E6E2] text-[#141414] hover:bg-[#141414] hover:text-white py-3.5 rounded-full font-bold text-sm transition-all cursor-pointer shadow-xs"
          >
            Get Started →
          </button>
        </div>

        {/* Tier 2: Growth (Most Popular - Vibrant Red Card) */}
        <div className="bg-[#E8402F] text-white rounded-3xl p-7 sm:p-8 flex flex-col justify-between shadow-2xl relative transform md:-translate-y-2">
          {/* Popular Badge */}
          ...
          <button
            ...
            className="w-full mt-8 bg-white text-[#E8402F] hover:bg-[#141414] hover:text-white py-3.5 rounded-full font-extrabold text-sm transition-all cursor-pointer shadow-lg"
          >
        ...
        <div className="bg-[#F3F3F1] border border-[#E7E6E2] rounded-3xl p-7 sm:p-8 flex flex-col justify-between hover:border-[#141414] transition-all">
          ...
          <button
            ...
            className="w-full mt-8 bg-[#141414] text-white hover:bg-[#E8402F] py-3.5 rounded-full font-bold text-sm transition-all cursor-pointer shadow-xs"
          >
